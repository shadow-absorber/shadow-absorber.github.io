...
today scripts are some color printing ones

the first one here prints out all 256 colors:
...
this second one prints out all foreground and background color combinations making it easy to check your colorscheme:
```bash
print_colors() {
...
and that is all for day 2 of scripts by shadow
